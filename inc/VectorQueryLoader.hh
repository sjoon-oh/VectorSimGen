...
namespace vsg
{
    ...
    public:
        VectorQueryLoader() noexcept
        {
            m_logger.reset(new Logger("QueryLoader"));
            printLog(ENABLE_PRINTLOG, "QueryLoader initialized.");
        }

        virtual ~VectorQueryLoader() noexcept
        {
